...
\definecolor{backcolor}{RGB}{240,240,225}
\definecolor{defaultcolor}{RGB}{20,20,20}
\definecolor{commentcolor}{RGB}{98,98,98}
\definecolor{stringcolor}{RGB}{23,140,100}
\definecolor{builtincolor}{RGB}{221,40,103} % if, while
\definecolor{functioncolor}{RGB}{80,150,33}
\definecolor{numberscolor}{RGB}{20,20,20}
...
\lstdefinestyle{pythonstyle}{
	...
	keywordstyle=\color{builtincolor}, % Keyword style (e.g., def, if)
	basicstyle=\ttfamily\footnotesize\color{defaultcolor}, % Basic font style
	...
	breakatwhitespace=true,           % Line breaking at whitespace
	title=\lstname,                   % Show filename with \lstinputlisting
	numbers=left,                     % Line numbers on the left
	numberstyle=\tiny\color{commentcolor}, % Line number style
	keywords={[2]print,input,open,close,read,write,append}, 
	keywordstyle={[2]\color{functioncolor}},
	keywords={[3]numpy,pandas,matplotlib,os,sys}, 
	keywordstyle={[3]\color{defaultcolor}},
}

\lstset{style=pythonstyle, frame=single, frameround=tttt, columns=fullflexible}
...
%\begin{figure}[h!]
%	\centering
%	\includegraphics[width=0.4\linewidth]{sentry2}
%	\caption{Összeállított prototípus}
%	\label{fig:sentry2}
%\end{figure}
\pagebreak
