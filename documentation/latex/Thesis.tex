...
Kétséges rész volt a \textbf{motor} rögzítése, ugyanis nagy szükség van a pontos illeszkedésre. A nyomtatás irányára azonban a motor központosítására szánt furat pont merőleges, de szerencsére a nyomtató így is elég nagy pontosságot tudott elérni. A motor beépítése a 
...
\begin{list}{-}{}
	...
	\item Az egyesített képkockát visszafejti (unpickling és JPEG dekódolás), majd a \code{cv2.imshow()} segítségével megjeleníti.
\end{list}
